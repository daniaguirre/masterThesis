...
@#$#@#$#@
<experiments>
  <experiment name="experiment-arraivail-buffer" repetitions="2" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <final>export-view "vista.png"</final>
    <metric>total-wireless-losses + total-routing-losses + total-congestion-losses</metric>
    <steppedValueSet variable="arraival-rate" first="1" step="1" last="3"/>
